...
# It is possible to override e-mail, Gotify, Matrix, Ntfy, Signalgrid and
# Telegram setting for every script. This is done in arrays, where
# 'Override' is appended to the variable name, like this:
